---
title: More Modules in DSPy
---

In addition to standard predictors like `dspy.Predict` and `dspy.ChainOfThought`, DSPy provides advanced modules for specialized reasoning tasks.
