...
sidebarTitle: Arbiters + LangSmith
---

You can use an Arbiter from Modaic as an LM judge in [LangSmith](https://smith.langchain.com/). This allows you to score LangSmith traces with a continuously improving evaluator.
...
![Prompts Tab](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/prompts_tab.png)

3. Click the model name to configure provider settings.
![New Prompt](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/new_prompt.png)

4. Set the provider to **OpenAI Compatible Endpoint**.
![Select Provider](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/select_provider.png)

5. Set the model to the name of your arbiter on Modaic. It should be in the format `<entity>/<arbiter-name>`.
![Model Name](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/enter_repo.png)

6. Select **Chat Completions** as the **Provider API** and set the **Base URL** to:
```
https://api.modaic.dev/api/v1/arbiters
```
![Base URL](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/set_base_url.png)
...
![Browser Secrets](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/set_browser_secret.png)
</Tab>
<Tab title="Workspace Secrets">
![Workspace Secrets](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/see_ws_secrets.png)
![Set Workspace Secret](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/workspace_secrets.png)
</Tab>
</Tabs>
...
![Prompt Template](https://d1pz4mbco29rws.cloudfront.net/public/docs/docs/arbiters/langsmith/prompt_template.png)
