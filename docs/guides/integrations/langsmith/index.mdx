...
You can use an Arbiter from Modaic Hub as an LLM judge in LangSmith. This allows you to score LangSmith traces with an aligned continously improving evaluator.
