...
You can use an Arbiter from Modaic as a scorer in [Braintrust](https://www.braintrust.dev/). This allows you to score Braintrust traces with a continuously improving evaluator.

## Create an Arbiter

[Create your arbiter](../../../guides/basic_usage/create_an_arbiter) and push it to the Modaic Hub.
