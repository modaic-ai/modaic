...
Generates a human-readable markdown representation of the table with headers and rows, perfect for displaying in documentation or DSPY program responses.
