...
Modaic provides several built-in context classes that you can use immediately or extend to create your own specialized contexts. These classes handle common data formats and implement useful behaviors for DSPY program interactions.
