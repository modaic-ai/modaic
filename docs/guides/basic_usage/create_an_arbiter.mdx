...
if __name__ == "__main__":
    ...
    ).as_arbiter() # Make your Predict instance an arbiter 
    code_completion_arbiter.push_to_hub(
        "roblox/code-completions", make_arbiter=True, private=True
    )
```
...
<Danger>
    Only certain models are supported for arbiters. See available models below
</Danger>

## Available Models
Don't see the model you're looking for? Send us a request and we'll have one up within 72 hours. [team@modaic.dev](mailto:team@modaic.dev)
- qwen3-32b
