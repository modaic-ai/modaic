...
my_program/
├── __init__.py
├── my_program.py # Contains your program class and config class (does not need to be named my_program.py)
...
my_program/
├── __init__.py
├── my_program/ # This is a subfolder containing your program definition and all supporting code. (does not need to be named my_program/)
│   ├── __init__.py
│   ├── my_program.py # Contains your program class and config class (does not need to be named my_program.py)
