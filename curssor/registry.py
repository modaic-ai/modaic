...
def get_or_create_node_class(model_cls: Type[BaseModel]) -> Type[GQLNode]:
    ...
    """
    from gqlalchemy.models import Node as _Node  # local import to avoid side-effects
...
def get_or_create_relationship_class(
    ...
    """
    from gqlalchemy.models import Relationship as _Relationship  # local import
