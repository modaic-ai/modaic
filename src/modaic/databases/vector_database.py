...
class VDBConfig(Protocol):
    # as already noted in comments, checking for this attribute is currently
    # the most reliable way to ascertain that something is a dataclass
    __dataclass_fields__: ClassVar[Dict[str, Any]]
    _backend: ClassVar[Type["VectorDBBackend"]]
...
class VectorDBBackend(Protocol):
    ...
    def __init__(self, config: VDBConfig) -> Any: ...
    def create_record(
    ...
    def print_available_functions(
        self, config_type: Type[VectorDatabaseConfig]
    ) -> None: ...
...
class VectorDatabase:
    def __init__(
        ...
        **kwargs,
        ...
        self._backend = self.config._backend(self.config)
        self.indexes = defaultdict(dict)
        self._schemas = {}  # collection_name -> modaic_schema
...
class MilvusBackend:
    ...
    def __init__(self, config: "MilvusVDBConfig") -> Any:
    ...
    def milvus_specific_function(self, *args, **kwargs) -> Any: ...

    def reindex(self, *args, **kwargs) -> Any: ...
