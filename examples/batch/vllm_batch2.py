"""Run VLLMBatchClient2 with vLLM's `run-batch` CLI inside a Modal container."""

from __future__ import annotations

import modal

APP_NAME = "modaic-vllm-run-batch-example"
...
async def run_example() -> list[dict[str, object]]:
    ...
    from modaic.batch import VLLMBatchClient2, abatch
