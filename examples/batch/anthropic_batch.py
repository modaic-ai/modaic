...
async def direct_client_example():
    """Example using AnthropicBatchClient directly via BatchJobRunner."""
    from modaic.batch import BatchJobRunner
    from modaic.batch.clients import AnthropicBatchClient
    from modaic.batch.types import BatchRequestItem

    client = AnthropicBatchClient(poll_interval=10.0, max_poll_time="1h")
    ...
    for raw_result in result.results:
        ...
        parsed = client.parse_result(raw_result)
